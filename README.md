...
Юрист-разработчик (Legal Tech) и промпт-инженер. Разрабатываю и внедряю AI-решения для юридических и бизнес-процессов: от анализа рисков и документов до чат-ботов и интеграций с CRM/API.
...
**Статус:** ✨ Активный проект  
**Ссыл��и:** [Презентация](https://drive.google.com/file/d/1H-bfHi59BMWlh43QXfev7K2_tNnk58jO/view) | [Тест-драйв в Telegram (@docsdemo_bot)](https://t.me/docsdemo_bot)
...
**Результат:** Полный цикл "сообщение → событие": бот распознает голос/текст, автоматически создает события и уведомления  
